...
import { 
  ...
  Mail, Tag, BarChart3, Settings, LogOut, Menu, X,
    ...
    <div className="min-h-screen bg-carbon-950 flex">
        ...
        <nav className="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
          {navigation.map((item) => (
            ...
            >
              ...
              {item.name}
              {item.name === 'Contacts' && stats.newContactsCount > 0 && (
      ...
      {sidebarOpen && (
        <div className="lg:hidden fixed inset-0 z-50">
          ...
          <aside className="fixed inset-y-0 left-0 w-64 bg-carbon-900 border-r border-carbon-800">
        ...
        <header className="h-16 flex items-center justify-between px-4 lg:px-8 border-b border-carbon-800 bg-carbon-900/50 backdrop-blur-sm sticky top-0 z-40">
          <div className="flex items-center gap-4">
            <button
              ...
              className="lg:hidden p-2 text-carbon-400 hover:text-white"
            >
